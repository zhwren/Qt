/****************************************************************************
** Meta object code from reading C++ file 'Detail.hh'
**
...
#error "The header file 'Detail.hh' doesn't include <QObject>."
...
const QMetaObject Detail::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Detail.data,
